                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$total_user??0}}</span></h3>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$total_post??0}}</span></h3>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$total_balance??0}}</span></h3>
                                        <p class="text-muted mb-1 text-truncate">User Balance</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$withdrows??0}}</span></h3>
                                        <p class="text-muted mb-1 text-truncate">Pending Deposit</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$deposits??0}}</span></h3>
                                        <p class="text-muted mb-1 text-truncate">Pending Withdrow</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
                    ...
                    <div class="widget-rounded-circle card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$wallet->wallet}}</span></h3>
                                        <p class="text-muted mb-1 text-truncate">Admin Balance</p>
                                    </div>
                                </div>
                            </div> <!-- end row-->
                        </div>
