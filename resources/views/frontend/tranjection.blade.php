                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="bg-body-tertiary rounded-3 p-3 mb-4">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tranjection History</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row notification-container mt-2">
                        ...
                        <h2 class="text-center">Tranjection HIstory</h2>
                            ...
                            <div class="card notification-card notification-invitation">
                                <div class="card-body">
                                    <table>
                                        <tr>
                                            <td style="width:70%">
                                                <div class="card-title"><h3>{{$item->subject}}</h3>
                                                    <strong class="text-danger">Amount - {{$item->change_amount}} | Tranjection Id - {{$item->tranjection}} |   Using Number - {{$item->number}}</strong>
                                                </div>
                                                <strong class="">{{$item->desc}}</strong>
