    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            exampleModal.addEventListener('show.bs.modal', function(event) {
                ...
                // var exchangeAmount = button.getAttribute('data-exchange_amount');
                ...
                // document.getElementById('amount').value = exchangeAmount;
                                // Add click event listener to the chat link
