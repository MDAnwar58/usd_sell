            ...
            <div class="row">
                <form action="{{ route('sell_store') }}" method="post" class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="quality" id="quality" aria-describedby="quality">
                        @error('quality')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="to_limit" id="to_limit">
                        @error('to_limit')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="from_limit" id="from_limit">
                        @error('from_limit')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="exchange_amount" id="exchange_amount">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="trade" id="trade">
                        @error('trade')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="completion" id="completion">
                        @error('completion')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="phone" class="form-control" name="contact_number" id="contact_number">
